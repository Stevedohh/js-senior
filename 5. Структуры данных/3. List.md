...
Сам список как правило имеет две ссылки *head* и *tail*, узел же может иметь ссылки *next* и *prev*.
...
Произвольная вставка в случае двусвязного списка и ссылки на узел $X$, будет выполняться за $O(1)$, в остальных случаях $O(n)$.
